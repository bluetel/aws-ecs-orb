...
ORB_STR_AUTO_VERSIONED_SECRETS="$(circleci env subst "$ORB_STR_AUTO_VERSIONED_SECRETS")"
...
CONTAINER_DEFS="$(python "$UPDATE_CONTAINER_DEFS_SCRIPT_FILE" "$PREVIOUS_TASK_DEFINITION" "$ORB_STR_CONTAINER_IMAGE_NAME_UPDATES" "$ORB_STR_CONTAINER_ENV_VAR_UPDATE" "$ORB_STR_CONTAINER_SECRET_UPDATES" "$ORB_STR_CONTAINER_DOCKER_LABEL_UPDATES" "$ORB_STR_AUTO_VERSIONED_SECRETS")"
